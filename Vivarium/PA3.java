...
private GLUT glut;
  ...
  public PA3()
  {
    ...
    setTitle("CS480: Fish Tank Simulator");
  ...
  public void keyTyped(KeyEvent key)
  {
      switch ( key.getKeyChar() ) {
        ...
        case 'f' : 
                   ...
                   break;
        case 'D' : //FOR TESTING PURPOSES AND DEBUGGING
        case 'd' : 
                   vivarium.drawFood = false;
                   break;
        case 'S' : //SPAWNS THE FISH AFTER IT'S BEEN EATEN
        case 's' : 
                   vivarium.eaten = false;
                   break;
        case 'T' : //FOR TESTING PURPOSES AND DEBUGGING
        case 't' :
        		vivarium.eaten = true;
        		break;
